                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4 ">
                            <div class="ms-3">
                                <p class="mb-2" style="color:#2e841f;">Total Movies</p>
                                <h6 class="mb-0" style="color: white;"><?php echo $totalMovies; ?></h6> <!-- Display total movies count -->
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            <div class="ms-3">
                                <p class="mb-2" style="color:#2e841f;">Total Users</p>
                                <h6 class="mb-0" style="color: white;"><?php echo $totalUsers; ?></h6> <!-- Display total users count -->
                            </div>
                        </div>
                    </div>
                </div>
